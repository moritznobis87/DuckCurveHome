...
| 2026-09-06 | Pufferfühler-Reihenfolge (Q2) | Die Komponenten-IDs folgen der Anlernreihenfolge, nicht der Einbauhöhe. An der Schichtung bei ruhendem Speicher abgelesen: `102` oben (55 °C), `100` mitte-oben (47 °C), `104` mitte-unten (36 °C), `101` unten (35 °C). `103` ist defekt. Die beiden untersten liegen nur 1 K auseinander – beim nächsten Laden gegenprüfen, der oberste Fühler steigt zuerst |
